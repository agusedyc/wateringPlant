...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center text-center">
              ...
              <p>This page you are looking for does not exist <a href="<?=site_url(); ?>">Report this?</a>
              </p>
                  ...
                  <div class="col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                              <a class="btn btn-default" href="<?=site_url(); ?>">Go!</a>
                          </span>
                    </div>
                  </div>
                </form>
    ...
    <!-- FastClick -->
    <script src="<?php echo base_url();?>assets/theme/gentelella/vendors/fastclick/lib/fastclick.js"></script>
    <!-- NProgress -->
    <script src="<?php echo base_url();?>assets/theme/gentelella/vendors/nprogress/nprogress.js"></script>
